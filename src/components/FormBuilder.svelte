<script lang="ts">
  ...
  const fieldTypes = {
    input: { icon: "T", label: "Text Input" },
    textarea: { icon: "⊞", label: "Text Area" },
  ...
  function handleDrop(e: DragEvent) {
    ...
    if (fieldType && fieldTypes[fieldType]) {
      const newField: Field = {
        ...
        attributes: {
          type: fieldType === 'input' ? 'text' : undefined,
        ...
        >
          {#each fields as field (field.id)}
            ...
            >
              ...
              <div class="bg-white rounded-lg border-2 p-4 {selectedField?.id === field.id ? 'border-indigo-500' : 'border-gray-200'}">
                ...
                {:else if field.type === 'radio' || field.type === 'checkbox'}
                  <div class={field.layout?.inline ? 'flex gap-4' : 'space-y-2'}>
                    {#each field.options || [] as option}
            ...
            <div class="space-y-4">
              ...
              <div class="mt-6">
                ...
                <div class="space-y-2">
                  ...
                  {#if selectedField.type === 'input' && selectedField.attributes.type === 'number'}
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-1">
                        Min Value
                      </label>
                  ...
                  {#if selectedField.type === 'input' && selectedField.attributes.type === 'email'}
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-1">
                        Email Pattern
                      </label>
